    ...
    <div className="standings-table-container">
      <div className="table-header-row">
        ...
        <span className="table-hint">
          * Click any team row to view its detailed club profile
        </span>
      </div>
      ...
      <table className="standings-table">
        <thead>
          <tr>
            ...
            <th className="hide-mobile" style={{ textAlign: "center" }}>
              W
            </th>
            <th className="hide-mobile" style={{ textAlign: "center" }}>
              D
            ...
            <th className="hide-tablet" style={{ textAlign: "center" }}>
              GF
            </th>
            <th className="hide-tablet" style={{ textAlign: "center" }}>
              GA
            ...
            <th className="hide-tablet">Form</th>
          </tr>
        </thead>
        <tbody>
          {sortedData.map((team) => {
            ...
            return (
              ...
              >
                  ...
                  <div className="table-team-cell">
                    ...
                    <span>
                      ...
                      {team.isLive && (
                        <span
                          className="live-tag"
                          style={{ marginLeft: "6px", fontSize: "8px" }}
                        >
                          LIVE
                        </span>
                      )}
                ...
                <td className="hide-tablet">
                  <div
                    className="form-dots"
                    style={{ scale: "0.9", transformOrigin: "left center" }}
                  >
                    {formList.map((outcome, idx) => {
                      ...
                      return (
                        <span
                          key={idx}
                          className={`form-dot ${statusClass}`}
                          title={outcome}
                        >
                          {outcome}
                        </span>
